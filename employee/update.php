...
$row = mysqli_fetch_array($result,MYSQLI_ASSOC);
 if (isset($_POST['insert'])){
        ...
        $title=$_POST['title'];
        $type=$_POST['type'];
        $sql1="UPDATE accountsholder as a,accounts_info as c set a.name='$name',a.birth_place='$birth_place',a.nik='$nik',a.contact='$contact',a.dob='$dob',a.gender='$gender',a.email='$email',a.postal='$postal',a.city='$city',a.house_address='$address',c.account_type='$type',c.account_title='$title' where a.account=c.account and a.account='$id'";
            ...
            <div class="row clearfix">
                   ...
                   <div class="box-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4">
                                <p for="exampleInputPassword1" style="margin-bottom: 1px; margin-top: 8px;">Tipe Rekening</p>
                                <select class="form-control" name="type" required>
                                  <?php if($row['account_type']=="Tabungan") {?>
                                  <option selected value="Tabungan">Rekening Tabungan</option>
                                  <option value="Giro">Rekening Giro</option>
                                  <?php }
                                  if($row['account_type']=="Giro"){ ?>
                                    <option  selected value="Giro">Rekening Giro</option>
                        ...
                        <div class="row">
                         <div class="col-sm-12">
                          <center>
                           <button type="submit" style="width: 40%; padding: 10px; border-radius: 10px; font-size: 15px;" class="btn btn-primary" name="insert">Perbarui Data Rekening</button>
                          </center>
                        </div>
                       </div>
                      </div>
