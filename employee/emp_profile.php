    ...
    <section class="content" id="top">
        <div class="container-fluid">
            <div class="block-header">
                <div class="col-sm-8">
                    <p style="margin-left: -15px; font-size: 17px; font-weight: bold;">Detail Akun</p>
                </div>
                <div class="col-sm-4">
            ...
            <form id="form" method="post">
                ...
                <div class="box-body">
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <p for="exampleInputPassword1" style="margin-bottom: 1px; margin-top: 8px;">Jenjang Pendidikan
                            </p>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <p for="exampleInputPassword1" style="margin-bottom: 1px; margin-top: 8px;">Jenis Pengguna</p>
