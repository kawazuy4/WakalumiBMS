    ...
    <section class="content" id="top">
        <div class="container-fluid">
            <div class="block-header">
                <p style="margin-left: -15px; font-size: 17px; font-weight: bold;">DAFTAR REKENING</p>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-2">
                        <select class="form-control" onchange="myfun()" id="tp">
                            <option selected disabled hidden value="">Pilih Tipe</option>
                    ...
                    <table class="table" id="myTable">
                        <thead>
                            <tr style="text-align: center;" class="tb">
                                ...
                                <th style="text-align: center; width: 20%;">Nama Rekening</th>
                                <th style="text-align: center; width: 14%;">Nomor Rekening</th>
                                <th style="text-align: center; width: 11%;">Tipe Rekening</th>
                        ...
                        <tbody id="body">
                            ...
                            if (isset($_POST['filter'])) {
                                ...
                                $sql = "SELECT accountsholder.account as acc, accountsholder.nik as nik, accountsholder.name as nm, accounts_info.account_title as tit, accounts_info.account_type as typ, accounts_info.register_date AS det, accountsholder.npwp as npwp FROM accountsholder, accounts_info where accountsholder.account = accounts_info.account and accounts_info.register_date between '$startdt' and '$enddt' ORDER BY accountsholder.account DESC";
                                ...
                                if (mysqli_num_rows($num) > 0) {
                                    while ($row = mysqli_fetch_array($result)) {
                                        ...
                                        <tr style="height: 50px;">
                                            ...
                                            <td style="text-align: center;padding-top: 25px;"><?php echo $row['npwp']; ?></td>
                                            <td style="text-align: center;padding-top: 15px;">
                                                <div class="action_btn"><a href="view_profile.php?id=<?php echo $row['acc']; ?>"
                                                        class="click_ripple_shine success" title="View"><i
                                                            class="icon fa fa-eye"></i> </a>
                                                    <a href="update.php?id=<?php echo $row['acc']; ?>"
                                                        class="click_ripple_shine warning" title="Edit"><i
                            ...
                            <tr class='no-records'
                                ...
                                <td colspan='7'>Riwayat Kosong</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
    ...
    <script>
        ...
        function myfun() {
            ...
            for (i = 0; i < tr.length; i++) {
                ...
                if (td) {
                    txtValue = td.textContent || td.innerText;
                    if (filter == "GIRO" || filter == "TABUNGAN") {
                        ...
                        if (txtValue.toUpperCase().indexOf("GIRO") > -1 || txtValue.toUpperCase().indexOf("TABUNGAN") > -1) {
                            tr[i].style.display = "";
                        } else {
                            tr[i].style.display = "none";
                        }
