...
<body class="theme-blue">
        ...
        <div class="container-fluid">
            <div class="block-header">
                <p style="margin-left: -15px; font-size: 17px; font-weight: bold;">
                    <?php echo "Daftar Rekening " . $_GET["id"] ?></p>
            </div>
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <input type="text" id="myInput" class="cs form-control" onkeyup="myFunction()"
                            placeholder="Cari berdasarkan Nama, NIK, Nomor Rekening" title="Type in a name">
                    </div>
                    ...
                    <table class="table" id="myTable">
                        <thead>
                            <tr style="text-align: center;" class="tb">
                                ...
                                <th style="text-align: center; width: 10%;">Tipe Rekening</th>
                            </tr>
                        </thead>
                        <tbody id="body">
                            <?php
    ...
    <script type="text/javascript">
        $('.danger').on('click', function (e) {
            ...
            Swal.fire({
                title: 'Komformasi hapus akun?',
                text: "Akun yang telah dihapus tidak bisa dikembalikan!",
                icon: 'warning',
