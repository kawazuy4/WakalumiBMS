    ...
    <section class="content" id="top">
        <div class="container-fluid">
            <div class="block-header">
                <div class="col-sm-8">
                    <p style="margin-left: -15px; font-size: 17px; font-weight: bold;">Informasi Rekening</p>
                </div>
                <div class="col-sm-4">
            ...
            <form id="form" method="post">
                ...
                <div class="box-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            ...
                            <input type="text" class="form-control" name="acc_type"
                                value="<?php echo $row['account_type']; ?> " readonly>
                        </div>
                        <div class="col-lg-4">
                    ...
                    <div class="row">
                        <div class="col-lg-2">
                            <p for="exampleInputPassword1" style="margin-bottom: 1px; margin-top: 8px;">Saldo Terkini
                            </p>
                            <input type="text" class="form-control" name="bnc"
                            value="<?php echo 'Rp ' . number_format($row['balance'], 0, '', '.') . ',00-'; ?>" readonly>
                        </div>
                        <div class="col-lg-2">
                            <p for="exampleInputPassword1" style="margin-bottom: 1px; margin-top: 8px;">Deposito
                            </p>
                            <input type="text" class="form-control" value="<?php echo $dp1; ?>" readonly>
                        </div>
                        <div class="col-lg-2">
                            <p for="exampleInputPassword1" style="margin-bottom: 1px; margin-top: 8px;">Informasi Tarik Tunai
                            </p>
                            <input type="text" class="form-control" value="<?php echo $with1; ?>" readonly>
                        </div>
                        <div class="col-lg-2">
                            <p for="exampleInputPassword1" style="margin-bottom: 1px; margin-top: 8px;">Transaksi
                                Balance</p>
                            <input type="text" class="form-control" value="<?php echo $sent1; ?>" readonly>
                        </div>
                        <div class="col-lg-2">
                            <p for="exampleInputPassword1" style="margin-bottom: 1px; margin-top: 8px;">Saldo Diterima
                            </p>
                        ...
                        <div class="col-lg-2">
                            ...
                            <a href="history.php?id=<?php echo $row['account']; ?>"><i class="btn btn-primary">Detail Riwayat</i></a>
                            <?php
                            $_SESSION["hi"] = true;
                            ?>
                        </div>
        ...
        <div class="footer-basic" id="bot">
                <footer>
                    ...
                    <ul class="list-inline">
                        ...
                        <li class="list-inline-item"><a href="employee/about.php?type=Services">Layanan</a></li>
                        <li class="list-inline-item"><a href="employee/about.php?type=About">Tentang Kami</a></li>
                        <li class="list-inline-item"><a href="employee/about.php?type=Privacy">Mengenai Privasi</a></li>
                    </ul>
